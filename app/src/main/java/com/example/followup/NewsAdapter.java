...
public class NewsAdapter extends BaseAdapter {
    ...
    public NewsAdapter(Context c) {
        ...
        for (int i = 0; i < 10; i++) {
            newsSource.add(new NewsItem("title " + (i + 1) + " titletitletitletitletitletitletitletitletitletitletitletitletitletitletitletitletitletitletitletitletitle", "source", "date", R.drawable.avatar));
        }
    }
